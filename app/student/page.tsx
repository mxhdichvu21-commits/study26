...
const navItems = ["Trang chủ", "Vào phòng", "Lịch học", "Bài học", "Bài tập", "Thông báo", "Ghi chú", "Thành tích", "Cài đặt"];
const stats = [["Lớp học của bạn", "5"], ["Bài tập cần làm", "3"], ["Điểm trung bình", "8.6"], ["Thời gian học", "12h 30m"]];
const name = "An Nguyễn";
const roleLabel = "Học sinh";
const subtitle = "Hôm nay là một ngày tuyệt vời cho việc học tập!";
