...
const navItems = ["Trang chủ", "Tạo phòng", "Đặt lịch", "Thông báo", "Ghi chú"];
const stats = [["Tổng số lớp", "12"], ["Tổng học sinh", "256"], ["Lịch học hôm nay", "5"], ["Tổng thời lượng", "24h 30m"]];
const name = "Minh Anh";
const roleLabel = "Giáo viên";
const subtitle = "Hôm nay là một ngày tuyệt vời để dạy học!";
